...
int main(){
  int  month, day, days, day2, month2, year = 2018;
  printf("Enter started day and month: <day month >\n");
  scanf("%d %d", &day, &month );
  printf("Enter left day and month: <day month >\n");
  scanf("%d %d", &day2, &month2 );
  printf("Number of days : %d\n", dayOfYear(day2, month2, year) - dayOfYear(day, month, year) + 1 );
